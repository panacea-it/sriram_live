          ...
          <div className="flex flex-col items-end lg:items-start gap-3 relative">
            ...
            >
             ...
             <div
                ...
                className="w-[26px] h-[26px] bg-[#FFFFFF40] rounded-full flex items-center justify-center cursor-pointer flex-shrink-0"
              >
          ...
          <nav className="hidden lg:flex items-center gap-0 text-[16px] uppercase text-white/80 font-medium">
              <div className="relative group" ref={coursesButtonRef}>
                <button
                  ...
                  className={`flex items-center gap-1 transition-all duration-300 px-1 py-2 rounded-[6px] hover:text-white text-[14px] xl:text-[14px] uppercase text-white/80 font-bold cursor-pointer ${isCoursesOpen
                    ? 'text-white bg-[linear-gradient(90deg,rgba(0,159,238,0.8)_34.5%,#005B88_100%)] shadow-[0px_4px_32px_0px_#0000001A]'
                    : ''
                    }`}
                >
              ...
              <div ref={freeResourcesMenuRef} className="flex items-center">
                ...
                >
                  ...
                  <button
                    ...
                    className={`pr-2 pl-1 py-2 flex items-center justify-center ${isFreeResourcesOpen ? 'text-white' : 'text-white/80 hover:text-white'}`}
                  >
              ...
              <div ref={currentAffairsMenuRef} className="flex items-center">
                ...
                >
                  <Link
                    ...
                    className={`pl-2 pr-1 py-2 uppercase text-[14px] xl:text-[14px] font-bold ${isCurrentAffairsOpen ? 'text-white' : 'text-white/80 hover:text-white'}`}
                  >
                    Current Affairs
                  </Link>
                  <button

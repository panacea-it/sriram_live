...
const Header: React.FC = () => {
  ...
  const cities = [
    {
      name: 'New Delhi',
      icon: <Landmark size={28} strokeWidth={1.8} className="text-[#111111]" />,
    },
    {
      name: 'Hyderabad',
      icon: <Castle size={28} strokeWidth={1.8} className="text-[#111111]" />,
    },
    {
      name: 'Pune',
      icon: <Building2 size={28} strokeWidth={1.8} className="text-[#111111]" />,
    },
  ];
      ...
      >
        <div className="w-full max-w-[1400px] mx-auto flex justify-between items-center relative">
          ...
          <div className="flex flex-col items-end lg:items-start gap-3 relative">
            <div className="hidden lg:flex items-center gap-3 text-[16px] font-medium leading-[100%] tracking-normal uppercase text-white/80">
              <a
                href="/blogs"
              ...
              <div className="relative" ref={centersButtonRef}>
                <button
                  ...
                  className={`uppercase px-3 py-2 rounded-[6px] transition-all duration-300 hover:text-white text-[14px] xl:text-[14px] text-white/80 font-bold cursor-pointer ${isCentersOpen
                    ? 'text-white bg-[linear-gradient(90deg,rgba(0,159,238,0.8)_34.5%,#005B88_100%)] shadow-[0px_4px_32px_0px_#0000001A]'
                    : ''
                    }`}
                >
                  OUR CENTERS
              ...
              <button
                ...
                className="text-white font-medium px-3 py-2.5 rounded-[10px] transition-all duration-300 shadow-[0px_4px_32px_0px_#0000001A] text-[14px] xl:text-[14px] uppercase"
                style={{ background: 'linear-gradient(90deg, #00679C 0%, #002436 100%)' }}
              >
                BOOK FREE DEMO
              </button>
              <div className='w-[26px] h-[26px] bg-[#FFFFFF40] rounded-full flex items-center justify-center cursor-pointer flex-shrink-0'>
                <Image src="/assets/Search-Icon.svg" alt="search" width={13} height={15} />
              </div>

              <div className="flex items-center justify-center cursor-pointer ml-0">
            ...
            <div className="flex lg:hidden items-center gap-3 md:gap-4 text-white">
              ...
              <div className="cursor-pointer hover:text-primary transition-colors border-2 border-white rounded-full p-0.5 flex items-center justify-center">
                <User size={20} className="md:w-[22px] md:h-[22px]" />
              </div>
            </div>

            <nav className="hidden lg:flex items-center gap-3 text-[16px] uppercase text-white/80 font-medium">
              <div className="relative group" ref={coursesButtonRef}>
                <button
                  ...
                  className={`flex items-center gap-1 transition-all duration-300 px-3 py-2 rounded-[6px] hover:text-white text-[14px] xl:text-[14px] uppercase text-white/80 font-bold cursor-pointer ${isCoursesOpen
                    ? 'text-white bg-[linear-gradient(90deg,rgba(0,159,238,0.8)_34.5%,#005B88_100%)] shadow-[0px_4px_32px_0px_#0000001A]'
                    : ''
                    }`}
                >
              ...
              <div ref={freeResourcesMenuRef} className="flex items-center">
                <div
                  className={`flex items-center rounded-[6px] transition-all duration-300 cursor-pointer ${isFreeResourcesOpen
                    ? 'bg-[linear-gradient(90deg,rgba(0,159,238,0.8)_34.5%,#005B88_100%)] shadow-[0px_4px_32px_0px_#0000001A]'
                    : ''
                    }`}
                >
                  <Link
                    ...
                    className={`pl-3 pr-1 py-2 uppercase text-[14px] xl:text-[14px] font-bold ${isFreeResourcesOpen ? 'text-white' : 'text-white/80 hover:text-white'}`}
                  >
                    Free Resources
                  </Link>
                  <button
                    ...
                    className={`pr-3 pl-1 py-2 flex items-center justify-center ${isFreeResourcesOpen ? 'text-white' : 'text-white/80 hover:text-white'}`}
                  >
                    <ChevronDown size={16} className={`transition-transform duration-300 ${isFreeResourcesOpen ? 'rotate-180' : ''}`} />
                  </button>
                </div>
              </div>

              <div ref={currentAffairsMenuRef} className="flex items-center">
                <div
                  className={`flex items-center rounded-[6px] transition-all duration-300 cursor-pointer ${isCurrentAffairsOpen
                    ? 'bg-[linear-gradient(90deg,rgba(0,159,238,0.8)_34.5%,#005B88_100%)] shadow-[0px_4px_32px_0px_#0000001A]'
                    : ''
                    }`}
                >
                  <Link
                    ...
                    className={`pl-3 pr-1 py-2 uppercase text-[14px] xl:text-[14px] font-bold ${isCurrentAffairsOpen ? 'text-white' : 'text-white/80 hover:text-white'}`}
                  >
                    Current Affairs
                  </Link>
                  <button
                    ...
                    className={`pr-3 pl-1 py-2 flex items-center justify-center ${isCurrentAffairsOpen ? 'text-white' : 'text-white/80 hover:text-white'}`}
                  >
                    <ChevronDown size={16} className={`transition-transform duration-300 ${isCurrentAffairsOpen ? 'rotate-180' : ''}`} />
                  </button>
                </div>
              </div>
              ...
              <Link
                href="/books"
                className="px-3 py-2 rounded-[6px] transition-all duration-300 hover:text-white text-[14px] xl:text-[14px] text-white/80 font-bold cursor-pointer"
              >
                Books
              </Link>
        ...
        <div
          ref={centersMenuRef}
          className={`absolute top-full left-0 right-0 mt-6 bg-[#F2F7F9] rounded-[32px] shadow-2xl border border-white/20 flex flex-col justify-center items-center overflow-hidden text-center cursor-default transform origin-top transition-all duration-300 z-50 min-h-[460px] ${
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center justify-center w-full h-full p-10">
            <h3
              className="text-xl font-[900] tracking-widest uppercase mb-16 font-['Montserrat']"
              style={{

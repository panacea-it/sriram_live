...
const studyMaterials = [
  { title: "PRELIMS - Study Material", file: "#" },
  { title: "PRELIMS - Study Material", file: "#" },
  { title: "PRELIMS - Study Material", file: "#" },
  { title: "PRELIMS - Study Material", file: "#" },
  { title: "PRELIMS - Study Material", file: "#" },
...
export default function StudyMaterialsPage() {
  ...
  return (
    <>
      ...
      <main ref={containerRef} className="w-full overflow-hidden bg-[#f7f8fb] font-['Montserrat',sans-serif]">
        {/* Banner */}
        ...
        {/* Content - Added Background Image Here */}
        <section className="relative bg-[url('/assets/free-resources/free-resource-bg-1.png')] bg-cover bg-center bg-no-repeat px-5 py-16 md:px-8 lg:px-12 xl:px-16">
          <div className="relative mx-auto max-w-[1400px]">
            <div className="grid grid-cols-1 gap-10 xl:grid-cols-[minmax(0,1fr)_340px] xl:gap-14">
              ...
              {/* Left Side (Heading + Tabs + Cards) */}
              <div>
                {/* Heading - Centered over the left content */}
...
{/* <div className="animate-tabs mx-auto mb-12 flex w-full items-center rounded-[20px] bg-[#F4F4F4] p-2 shadow-inner">
  {[
    ...
    const isNextActive = array[index + 1] && activeTab === array[index + 1].key;
    ...
    return (
      <React.Fragment key={tab.key}> 
        ...
        {index < array.length - 1 && (
          <div
            className={`h-10 w-[1px] transition-opacity duration-300 ${
              isActive || isNextActive ? "bg-transparent" : "bg-[#d9d9d9]"
            }`}
          ></div>
        )}
      </React.Fragment>
      ...
      <React.Fragment key={tab.key}>
        ...
        {index < array.length - 1 && (
          <div className="mx-2 h-18 w-[1.5px] bg-[#D9D9D9]"></div>
              ...
              {/* Right sidebar - Added xl:mt-[110px] to align with tabs! */}

...
import TestPaperCard from '@/components/common/TestPaperCard';
...
// --- Page Content ---
const dummyResults = [
  { id: 1, title: "Question Paper", viewLink: "#", downloadLink: "#" },
  { id: 2, title: "Question Paper", viewLink: "#", downloadLink: "#" },
  { id: 3, title: "Question Paper", viewLink: "#", downloadLink: "#" },
  { id: 4, title: "Question Paper", viewLink: "#", downloadLink: "#" },
];
...
export default function PreviousYearPage() {
  ...
  useGSAP(() => {
    ...
    gsap.fromTo(".animate-card",
      { y: 40, opacity: 0 },
      { y: 0, opacity: 1, stagger: 0.1, duration: 0.8, ease: "power3.out", clearProps: "transform", scrollTrigger: { trigger: ".animate-cards-container", start: "top 85%" } }
    );
  ...
  }, { scope: containerRef, dependencies: [prefersReducedMotion, activeSection, showResults] });
  ...
  return (
    <>
      ...
      <main ref={containerRef} className="min-h-screen bg-[#fcfcfc] font-['Montserrat',sans-serif]">
        {/* Banner */}
        ...
        {/* Content Section with wavy background pattern */}
        <section className="bg-[url('/assets/image-91.png')] relative bg-[#fcfcfc] bg-[url('/assets/bg-wave.png')] bg-cover bg-center bg-no-repeat px-6 py-16 lg:px-12 xl:px-16">
          <div className="mx-auto max-w-[1400px]">
            {activeSection === "LIST" ? (
              <>
                ...
                {/* Layout Grid */}
                <div className="bg-[url('/assets/image-91.png')] grid grid-cols-1 gap-8 lg:grid-cols-[minmax(0,1fr)_380px] xl:gap-10">
                  {/* LEFT SIDE CARDS */}
                  <div className="animate-cards-container grid grid-cols-1 gap-6 md:grid-cols-2 xl:gap-8">
                    {/* PRELIMS CARD */}
                    <div className="animate-card group relative flex min-h-[250px] w-full overflow-hidden rounded-[24px] bg-[#FDF6EA] p-8 
shadow-[0_4px_20px_rgba(0,0,0,0.04)] 
transition-all duration-300 ease-out 
hover:-translate-y-2 hover:scale-[1.03] hover:shadow-xl">

                      {/* Left Content */}
                      <div className="relative z-20 flex w-[55%] flex-col justify-center 
  ...
  group-hover:translate-x-2">
    ...
    group-hover:text-[#333]">
        ...
        bg-[linear-gradient(90deg,#2BA9E0,#032B3F)] 
        px-6 py-2.5 text-[14px] font-semibold text-white shadow-md 
        transition-all duration-300 
        hover:scale-105 group-hover:shadow-lg"
                      ...
                      <div className="absolute right-[-5%] top-0 flex h-full w-[50%] origin-right scale-125 items-center justify-center pointer-events-none md:scale-110 lg:scale-[1.3]">
                        ...
                        <svg viewBox="-40 -20 280 260" className="relative z-0 h-full w-full drop-shadow-xl 
    transition-all duration-500 group-hover:scale-105">
                          ...
                          <image
                            ...
                            x="-35" y="10" width="270" height="250"
        ...
        group-hover:scale-[1.08]"
                    ...
                    {/* MAINS CARD */}
                    <div className="animate-card group relative flex min-h-[250px] w-full overflow-hidden rounded-[24px] 
bg-[linear-gradient(135deg,#DCEAFC_0%,#C0DDF6_100%)] p-8 
shadow-[0_4px_20px_rgba(0,0,0,0.04)] 
transition-all duration-300 ease-out 
hover:-translate-y-2 hover:scale-[1.03] hover:shadow-xl">
    ...
    group-hover:text-[#333]">
        ...
        hover:scale-105 group-hover:shadow-lg"
                      ...
                      <div className="absolute right-[-5%] top-0 flex h-full w-[50%] origin-right scale-125 items-center justify-center pointer-events-none md:scale-110 lg:scale-[1.3]">
                        ...
                        <svg
                          viewBox="-40 -20 280 260"
                          className="relative z-0 h-full w-full drop-shadow-xl 
      transition-all duration-500 group-hover:scale-105"
                        >
                          <defs>
        ...
        group-hover:scale-[1.08]"
              ...
              <>
                ...
                <div className="grid grid-cols-1 gap-10 xl:grid-cols-[minmax(0,1fr)_380px]">
                  {/* Left side */}
                  <div>
                    {/* MOVED Detail View Title HERE to center above the dropdowns */}
                    ...
                    {/* Search controls replaced with CustomDropdown */}
                    <div className="animate-tabs relative z-[60] mb-12">
                      <div className="flex flex-col items-center justify-center gap-6 md:flex-row">
                        <CustomDropdown
                          options={
                            activeSection === "PRELIMS"
                              ...
                              : ["Essay", "GS Paper 1", "GS Paper 2", "GS Paper 3", "GS Paper 4", "Optional 1", "Optional 2"]
                          }
                          value={selectedPaper}
                        ...
                        <CustomDropdown
                          options={["2026", "2025", "2024 (dev will add 2015)", "2023", "2022", "2021", "2020"]}
                          value={selectedYear}
                    ...
                    {/* Results */}
                    {showResults && (
                      <div className="bg-[url('/assets/image-91.png')] bg-cover bg-center animate-cards-container grid grid-cols-1 gap-5 md:grid-cols-2">
        ...
        transition-all duration-300 group-hover:scale-110">
          ...
          transition-all duration-300 group-hover:text-black">
                                ...
                                <div className="mt-4 flex flex-wrap gap-3">
                                  ...
                                  <Link
                                    href={book.viewLink}
                                    className="inline-flex min-w-[88px] items-center justify-center rounded-[10px] 
              border border-[#58b7ea] bg-white px-5 py-2 text-[15px] font-bold text-[#2a9cda] 
              transition-all duration-300 
              hover:bg-[linear-gradient(90deg,#2aa7df_0%,#03283b_100%)] hover:text-white 
              group-hover:shadow-md"
                                  ...
                                  <Link
                                    ...
                                    className="inline-flex min-w-[140px] items-center justify-center rounded-[10px] 
              border border-[#58b7ea] bg-white px-5 py-2 text-[15px] font-bold text-[#2a9cda] 
              transition-all duration-300 
              hover:bg-[linear-gradient(90deg,#2aa7df_0%,#03283b_100%)] hover:text-white 
              group-hover:shadow-md"
                  ...
                  {/* Right side - aligned with left content */}

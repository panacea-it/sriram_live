...
const paperOptions = ['General Studies I', 'General Studies II', 'General Studies III', 'General Studies IV', 'Essay'];
const yearOptions = ['2026', '2025', '2024(dev will add 2015)'];

const paperCards = [
  { id: 1, title: 'Mains Exam Paper-1 Question Paper', fileUrl: '#' },
  { id: 2, title: 'Mains Exam Paper-2 Question Paper', fileUrl: '#' },
  { id: 3, title: 'Mains Exam Paper-3 Question Paper', fileUrl: '#' },
  { id: 4, title: 'Mains Exam Paper-4 Question Paper', fileUrl: '#' },
  { id: 5, title: 'Mains Exam Paper-5 Question Paper', fileUrl: '#' },
];
        ...
        <div className="absolute left-0 top-[68px] z-50 w-full rounded-[22px] bg-[#E8ECFA] py-4 shadow-[0_10px_24px_rgba(0,0,0,0.10)]">
          {options.map(o => (
            <button key={o} type="button" onClick={() => { onChange(o); setOpen(false); }}
              className="block w-full px-6 py-3 text-center text-[17px] font-semibold text-black transition-colors hover:bg-[#dde4fb]">
              {o}
            </button>
          ))}
        </div>
...
export default function MainsPaperPage() {

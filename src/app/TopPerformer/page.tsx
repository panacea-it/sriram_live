...
const StarAvatar = ({ image, name }: { image: string; name: string }) => (
  <div className="relative" style={{ width: 52, height: 58, flexShrink: 0 }}>
    {/* White star behind */}
    <svg
      width="52"
      height="58"
    ...
    {/* Photo on top — overflows naturally like image 2 */}
    <img
      src={image}
      alt={name}
      className="absolute"
